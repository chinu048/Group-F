...
# Form implementation generated from reading ui file '/home/sandarbh/Desktop/Sourcerer/GUI/forgotPassword.ui'
#
# Created: Tue Apr 10 00:02:53 2018
...
"}"))
        ...
        self.recover_pwd = QtGui.QPushButton(self.centralwidget)
        self.recover_pwd.setMaximumSize(QtCore.QSize(150, 16777215))
        font = QtGui.QFont()
        font.setPointSize(-1)
        self.recover_pwd.setFont(font)
        self.recover_pwd.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.recover_pwd.setToolTip(_fromUtf8(""))
        self.recover_pwd.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.recover_pwd.setStyleSheet(_fromUtf8("padding:5px;\n"
"border-radius:5;margin-top:10px;\n"
"background-color: #4988af;margin-bottom: 150px;"))
        self.recover_pwd.setFlat(False)
        self.recover_pwd.setObjectName(_fromUtf8("recover_pwd"))
        self.gridLayout.addWidget(self.recover_pwd, 4, 0, 1, 1)
...
"margin-bottom: 50px;"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:48pt; color:#4988af;\">RECOVERY</span></p></body></html>", None))
        self.recover_pwd.setText(_translate("MainWindow", "RECOVER", None))
...
if __name__ == "__main__":
    ...
    MainWindow.setWindowTitle("Password Recovery")
    MainWindow.show()
    sys.exit(app.exec_())
